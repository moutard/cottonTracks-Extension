  ...
  Cotton.Analytics = Class
      .extend({
        ...
        clickDefaultElementFeaturedImage : function() {
          _gaq.push([ '_trackEvent', 'Story use',
              'Element Featured Image Clicked', 'Default Element' ]);
        },
        ...
        clickSearchElementFeaturedImage : function() {
          _gaq.push([ '_trackEvent', 'Story use',
              'Element Featured Image Clicked', 'Search Element' ]);
        },
        ...
        viewVideo : function() {
          _gaq.push([ '_trackEvent', 'Story use', 'Video viewed',
              'Video Element' ]);
        },
