      ...
      init : function() {
        ...
        for ( var iI = 0; iI < 1; iI++) {
          new Cotton.UI.Homepage.Ticket(this, 'images/home/tickets/TC.jpg',
              ...
              'http://techcrunch.com');
          new Cotton.UI.Homepage.Ticket(this, 'images/home/tickets/Fubiz.jpg',
              Math.floor(Math.random() * 80 + 10), 'Fubiz', 'http://fubiz.net');
          new Cotton.UI.Homepage.Ticket(this, 'images/home/tickets/FB.jpg',
          ...
          new Cotton.UI.Homepage.Ticket(this,
              ...
              'http://pandodaily.com');
          new Cotton.UI.Homepage.Ticket(this, 'images/home/tickets/MTV.jpg',
              Math.floor(Math.random() * 80 + 10), 'MTV', 'http://www.mtv.com');
          new Cotton.UI.Homepage.Ticket(this,
              'images/home/tickets/Twitter.jpg', Math
                  .floor(Math.random() * 80 + 10), 'Twitter',
              'http://twitter.com');
          new Cotton.UI.Homepage.Ticket(this,
              'images/home/tickets/Pinterest.jpg', Math
