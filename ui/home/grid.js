    ...
    .extend({
      ...
      init : function() {
        ...
        for ( var iI = 0; iI < 1; iI++) {
          new Cotton.UI.Home.Ticket(this, '/media/images/home/tickets/TC.jpg',
          ...
          new Cotton.UI.Home.Ticket(this, '/media/images/home/tickets/FB.jpg',
              Math.floor(Math.random() * 80 + 10), 'Facebook',
              'http://facebook.com');
          new Cotton.UI.Home.Ticket(this, 'images/home/tickets/Dribbble.jpg',
              Math.floor(Math.random() * 80 + 10), 'Dribbble',
              'http://dribbble.com');
          new Cotton.UI.Home.Ticket(this, 'images/home/tickets/PandoDaily.jpg',
              Math.floor(Math.random() * 80 + 10), 'PandoDaily',
              'http://pandodaily.com');
          new Cotton.UI.Home.Ticket(this, '/media/images/home/tickets/MTV.jpg',
