 ...
 *     takes a JSON response object sent by the handler of the request.
 */
chrome.extension.sendMessage = function(opt_arg1, opt_request, opt_callback) {};
chrome.runtime.sendMessage = function(opt_arg1, opt_request, opt_callback) {};
...
/** @type {method} */
chrome.browserAction.onClicked.dispatch = function() {};
 ...
 *
 */
chrome.history.onInstalled = function() {};

/**
 *
 */
chrome.history.onInstalled.addListener = function() {};

/** @see http://code.google.com/chrome/extensions/topSites.html */
chrome.topSites = {};
