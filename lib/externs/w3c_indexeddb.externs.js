 ...
 * @param {string=}
 *          opt_description The description of the database.
 ...
 * @return {!IDBRequest} The IDBRequest object.
 */
IDBFactory.prototype.getDatabaseNames = function() {};
 ...
 * @type {function(Event)}
 */
IDBRequest.prototype.onupgradeneeded = function() {};
 ...
 * @param {Object=}
 *          opt_parameters Parameters to be passed creating the object store.
...
/**
 * @param {string}
 *          name The name of the object store to remove.
 */
...
/**
 * @param {Array.
 *          <string>} storeNames The stores to open in this transaction.
 * @param {number=}
 *          mode The mode for opening the object stores.
...
/**
 * @param {*}
 *          value The value to add into the object store.
 * @param {*=}
 *          key The key of this value.
 * @return {!IDBRequest} The IDBRequest object.
 */
...
/**
 * @param {*}
 *          key The key of the document to remove.
 * @return {!IDBRequest} The IDBRequest object.
 */
...
/**
 * @param {*}
 *          key The key of the document to retreive.
 * @return {!IDBRequest} The IDBRequest object.
 */
...
/**
 * @param {IDBKeyRange=}
 *          range The range of the cursor.
 * @param {number=}
 *          direction The direction of cursor enumeration.
 * @return {!IDBRequest} The IDBRequest object.
 */
 ...
 * @param {Object=}
 *          opt_paramters Optional parameters for the created index.
...
/**
 * @param {string}
 *          name The name of the index to retreive.
 * @return {!IDBIndex} The IDBIndex object.
 */
 ...
 *          indexName The name of the index to remove.
 */
IDBObjectStore.prototype.delete = function(indexName) {};
...
/**
 * @param {*}
 *          key The id of the object to retreive.
 * @return {!IDBRequest} The IDBRequest object.
 */
...
/**
 * @param {*}
 *          value The new value for the current object in the cursor.
 * @return {!IDBRequest} The IDBRequest object.
 */
 ...
 *
 * @param {*=}
 *          key Continue enumerating the cursor from the specified key (or
 *          next).
 */
IDBCursor.prototype['continue'] = function(key) {};

/**
 * Note: Must be quoted to avoid parse error. (rmoutard)
 *
 * @param {*=}
 *          key Continue enumerating the cursor from the specified key (or
 *          next).
...
/**
 * @param {number}
 *          count Number of times to iterate the cursor.
 */
...
/**
 * @param {string}
 *          name The name of the object store to retreive.
 ...
 * @type {Function}
 */
IDBTransaction.prototype.onupgradeneeded = function() {};

/**
 * @type {Function}
 */
IDBTransaction.prototype.onblocked = function() {};
...
/**
 * @param {*}
 *          value The single key value of this range.
...
/**
 * @param {*}
 *          bound Creates a lower bound key range.
 * @param {boolean=}
 *          open Open the key range.
 * @return {!IDBKeyRange} The key range.
 */
...
/**
 * @param {*}
 *          bound Creates an upper bound key range.
 * @param {boolean=}
 *          open Open the key range.
 * @return {!IDBKeyRange} The key range.
 */
...
/**
 * @param {*}
 *          left The left bound value of openLeft is true.
 * @param {*}
 *          right The right bound value of openRight is true.
 * @param {boolean=}
 *          openLeft Whether to open a left bound range.
 * @param {boolean=}
 *          openRight Whether to open a right bound range.
 * @return {!IDBKeyRange} The key range.
 */
